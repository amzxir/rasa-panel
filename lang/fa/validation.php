...
return [
    ...
    */
    ...
    'uploadedd' => 'انتخاب پیوست باید فایل و کمتر از 500 کیلوبایت باشد',
    ...
    */
    ...
    'attributes' => [
        ...
        "region" =>"منطقه" ,
        "slogan" =>"شعار کوتاه تیم" ,
        "tell" =>"تلفن ثابت" ,
        "nationalcode" => "کد ملی" ,
        "nationalcard" =>"کارت ملی" ,
        "bankno" =>"شماره کارت بانکی" ,
        "bankname" =>"نام بانک" ,
        "privacy" =>"نام بانک" ,
        "img" =>"تصویر" ,
        "desc" =>"توضیح" ,
        "slide1" =>" اسلاید تصویری اول" ,
        "slide2" =>"اسلاید تصویری دوم" ,
        "slide3" =>"اسلاید تصویری سوم" ,
        "callback" =>"ایمیل یا شماره تماس",
        "section" =>"مربوط به بخش ...",
        "status" =>"وضعیت" ,
        "cat" =>"دسته بندی" ,
        "section" =>"" ,
        "roleuser" => "نقش کاربری" ,
        "permissionuser" => "دسترسی کاربری" ,
        "periority" => "ضرورت" ,
        "section" => "وحد" ,
        "name_english" => "عنوان انگلیسی" ,
        "name_farsi" => "عنوان فارسی" ,
        "name_farsi" => "عنوان فارسی" ,
        ...
        "category"=>"دسته بندی",
        "sub_category"=>"زیر دسنه بندی",
        "tag"=>"برچسب",
        "bio"=>"بیوگرافی",
        "reply"=>"پاسخ",
        "ShopName" =>"نام فروشگاه",
        "NationalCode" => "کد ملی",
        "NationalCardImg" => "تصویر کارت ملی",
        "Certificate" => "مجوز",
        ...
        "fa_name" => "نام فارسی" ,
        "en_name" => "نام انگلیسی",
         "category_one" => "دسته بندی اصلی",
         "product_category" => "دسته بندی محصول",
         "country_maker" => "کشور سازنده",
         "product_show" => "نمایش محصول",
         "product_width" =>"عرض محصول" ,
         "originality_product" =>"اصالت محصول" ,
        "product_brand" => "برند محصول",
         "garantey" => "گارانتی محصول",
         "product_genus" => "جنس محصول",
         "product_stock" => "موجودی محصول",
         "product_length" =>"طول محصول" ,
         "product_height" => "ارتفاع محصول",
         "product_weight" =>"وزن محصول" ,
         "packing_weight" => "وزن بسته بندی",
        "packing_type" => "نوع بسته بندی",
         "images" => "تصاویر",
         "product_worth" => "قیمت محصول",
         "product_description" => "شرح محصول",
         "location" => "لوکیشن" ,
         "img" => "تصویر",
         "PostallCode" => "کد پستی",
         "PostallAdress" => "آدرس پستی",
         "province" => "استان",
         "brand" => "برند",
         "price" => "قیمت",
         "inventory" => "موجودی",
         ...
         "commission" => "کمیسیون",
         "link" => "لینک",
         "image_device_desktop" => "تصویر دسکتاپ",
         "image_device_mobile" => "تصویر موبایل",
         "old_address" => "آدرس قدیم",
