                        ...
                        <div class="card-body pt-7">
                            <div class="row">
                                <div class="col-md-12 mb-7">
                                    <input type="text" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="{{ trans('app.enter the banner transfer link')}}" />
                                </div>
                                <div class="col-md-12 mb-7">
                                    <select class="form-select form-select-solid" dir="rtl" data-control="select2" data-placeholder="{{ trans('app.placement of the banner')}}" data-hide-search="true">
                                        <option></option>
