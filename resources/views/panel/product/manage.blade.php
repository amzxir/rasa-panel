        ...
        <div class="card-header border-0 pt-6">
            <div class="card-title">
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <!--end::Svg Icon-->
                    <input type="text" data-kt-user-table-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="{{ trans('app.serach product')}}">
                </div>
            </div>
                ...
                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                        ...
                        <div class="px-7 py-5" data-kt-user-table-filter="form">
                            <div class="mb-7">
                                <input type="text" name="fname" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="{{ trans('app.name product')}}" />
                            </div>
                            <div class="mb-7">
                                <input type="text" name="fname" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="{{ trans('app.code product')}}" />
                            </div>
                            <div class="mb-7">
                                <input type="text" name="fname" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="{{ trans('app.category product')}}" />
                            </div>
                            <div class="mb-7">
                                <select class="form-select form-select-solid fw-bolder select2-hidden-accessible" dir="rtl" data-kt-select2="true" data-placeholder="{{ trans('app.status product')}}" data-allow-clear="true" data-kt-user-table-filter="two-step" data-hide-search="true" data-select2-id="select2-data-10-mptt" tabindex="-1" aria-hidden="true">
                            ...
                            <div class="d-flex justify-content-end">
                                ...
                                <button type="submit" class="btn btn-primary fw-bold px-6" data-kt-menu-dismiss="true" data-kt-user-table-filter="filter">تایید</button>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link">{{ trans('app.confirmed')}}</a>
                                    </div>
                                    <div class="menu-item">
                                        <a class="menu-link">{{ trans('app.not confirmed')}}</a>
                                    </div>
                                    <div class="menu-item">
