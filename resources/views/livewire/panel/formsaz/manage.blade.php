        ...
        <div class="card-body p-9">
            <div class="row">
                <div class="col-md-10 mb-7">
                    <select class="form-select form-select-solid" dir="rtl" data-control="select2" wire:model="search" data-placeholder="{{ trans('دسته بندی خود را انتخاب کنید')}}" data-hide-search="true">
                        <option></option>
                        <option value="دسته بندی اول">دسته بندی اول</option>
                    </select>
                </div>
                <div class="col-md-2 mb-7">
                    <button class="btn btn-primary w-100">{{ trans('app.reset page')}}</button>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-4">
                            <label class="required form-label fs-6 fw-bolder text-gray-700 mb-3">{{ trans('app.enter the attribute value')}}</label>
                            @error('attribute')
                                <small class="error">{{$message}}</small>
                            @enderror
                            <input type="text" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" wire:model="attribute" placeholder="{{ trans('app.enter the attribute value')}}" />
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-light" data-bs-dismiss="modal">{{ trans('app.close')}}</button>
                    <button type="button" class="btn btn-primary" wire:click="ConfirmAttributeValue">{{ trans('app.submit and next')}}</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" tabindex="-1" id="kt_modal_3" wire:ignore.self>
        <div class="modal-dialog modal-xl modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-light" data-bs-dismiss="modal">{{ trans('app.close')}}</button>
                    <button type="button" class="btn btn-primary" wire:click="ConfirmEditCategoryFormsaz">{{ trans('app.save chnage')}}</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" tabindex="-1" id="kt_modal_4" wire:ignore.self>
        <div class="modal-dialog modal-xl modal-dialog-centered">
            <div class="modal-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-7">
                            ...
                            @error('menu')
                                <small class="error">{{$message}}</small>
                            @enderror
                            <select class="form-select form-select-solid" dir="rtl" wire:model="menu" data-control="select2" data-placeholder="{{ trans('انتخاب کنید ...')}}" data-hide-search="true">
                                <option></option>
                        ...
                        <div class="col-md-6 mb-7">
                            ...
                            @error('peroperty')
                                <small class="error">{{$message}}</small>
                            @enderror
                            <select class="form-select form-select-solid" dir="rtl" wire:model="peroperty" data-control="select2" data-placeholder="{{ trans('انتخاب کنید ...')}}" data-hide-search="true">
                                <option></option>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-light" data-bs-dismiss="modal">{{ trans('app.close')}}</button>
                    <button type="button" class="btn btn-primary" wire:click="ConfirmEditFormsaz">{{ trans('app.save chnage')}}</button>
                </div>
            </div>
        </div>
    </div>
