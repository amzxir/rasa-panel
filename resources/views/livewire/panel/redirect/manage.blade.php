        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_کاربران">
            <thead>
                <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                    ...
                    <th class="min-w-125px">{{ trans('app.old address')}}</th>
                    <th class="min-w-125px">{{ trans('app.new address')}}</th>
            ...
            <tbody class="text-gray-600 fw-bold">
                <tr>
                    ...
                    <td>1</td>
                    <td>http://rasadent.reshe.ir/redirect-add</td>
                    <td>http://rasadent.reshe.ir</td>
                    <td class="text-end">
