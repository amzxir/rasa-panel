        ...
        <div class="modal-dialog modal-xl modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12 mb-7">
                            <label class="required form-label fs-6 fw-bolder text-gray-700 mb-3">{{ trans('app.redirect address')}}</label>
                            @error('redirect')
                                <small class="error">{{$message}}</small>
                            @enderror
                            <input type="text" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" wire:model="redirect" placeholder="{{ trans('app.redirect address')}}" />
                        </div>
                        <div class="col-md-12 mb-7">
                            <label class="required form-label fs-6 fw-bolder text-gray-700 mb-3">{{ trans('app.upload the banner file')}}</label>
                            @error('banner')
                                <small class="error">{{$message}}</small>
                            @enderror
                            ...
                            <input type="file" id="image" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0 d-none" wire:model="banner" />
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" wire:click="ConfirmEditBanner">{{ trans('app.submit')}}</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" tabindex="-1" id="kt_modal_2" wire:ignore.self>
        <div class="modal-dialog modal-xl modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="col-md-12 mb-7">
                        <label class="required form-label fs-6 fw-bolder text-gray-700 mb-3">{{ trans('app.display order in search')}}</label>
                        @error('display')
                            <small class="error">{{$message}}</small>
                        @enderror
                        <select class="form-select form-select-solid" dir="rtl" data-control="select2" wire:model="display" data-placeholder="{{ trans('app.display order in search')}}" data-hide-search="true">
                            <option></option>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-light" data-bs-dismiss="modal">{{ trans('app.close')}}</button>
                    <button type="button" class="btn btn-primary" wire:click="ConfirmDisplaySearch">{{ trans('app.submit')}}</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" tabindex="-1" id="kt_modal_3">
        <div class="modal-dialog modal-xl modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-light" data-bs-dismiss="modal">{{ trans('app.close')}}</button>
                    <button type="button" class="btn btn-primary" wire:click="">{{ trans('app.submit')}}</button>
                </div>
            </div>
        </div>
    </div>
