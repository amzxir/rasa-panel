                    ...
                    <tr>
                        ...
                        <td class="text-end">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item">
                                    <a class="menu-link" wire:click="ConfirmUserNotOk">{{ trans('app.block')}}</a>
                                </div>
                                <div class="menu-item">
                                    <a class="menu-link" wire:click="ConfirmUserOk">{{ trans('app.unblock')}}</a>
                                </div>
                                <div class="menu-item">
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered">
            <div class="modal-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-7">
                            ...
                            @error('access')
                                <small class="error">{{$message}}</small>
                            @enderror
                            <select class="form-select form-select-solid" dir="rtl" data-control="select2" wire:model="access" data-placeholder="{{ trans('app.access type')}}" data-hide-search="true">
                                <option></option>
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-primary" wire:click="ConfirmEditUser">{{ trans('app.submit')}}</button>
                </div>
            </div>
        </div>
    </div>
